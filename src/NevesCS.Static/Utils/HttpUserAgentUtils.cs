...
{
    public static class HttpUserAgentUtils
    {
        // Source: https://github.com/rummolprod999/RandomUserAgent/blob/master/RandomUserAgent/RandomUA.cs
        public static string GetNewRandomUserAgent()
        {
        ...
        public enum UserAgentBrowserName
        {
            [Description("Chrome")]
            Chrome,
        ...
        public const string DefaultUserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/420.69 (KHTML, like Gecko) Chrome/69.0.0.0 Safari/420.69";

        private static readonly Dictionary<string, List<string>> UaMap = [];
        private static readonly Dictionary<string, double> FreqMap = [];

        // TODO: Clean this up.
        static HttpUserAgentUtils()
        {
